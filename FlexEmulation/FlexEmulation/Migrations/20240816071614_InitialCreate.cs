    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SectionStudentCourses", x => x.Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SectionStudentCourses_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SectionCourseInstructors", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SectionCourseInstructors_Instructors_InstructorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SectionCourseInstructors_CourseId",
                table: "SectionCourseInstructors",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_SectionCourseInstructors_InstructorId",
                table: "SectionCourseInstructors",
                column: "InstructorId");

            migrationBuilder.CreateIndex(
                name: "IX_SectionCourseInstructors_SectionId",
                table: "SectionCourseInstructors",
                column: "SectionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SectionStudentCourses_StudentId",
                table: "SectionStudentCourses",
                column: "StudentId");
        }
